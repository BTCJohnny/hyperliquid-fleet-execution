...
Prints OK/FAIL to stdout — no desktop notifications. Designed to be run
manually (`python tools/health_check.py`) or quietly by launchd, with the
output piped to a log file (/Users/johnny_main/Developer/data/logs/healthcheck.out).
